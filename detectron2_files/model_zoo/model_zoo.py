...
from detectron2_files.checkpoint.detection_checkpoint import DetectionCheckpointer
from detectron2_files.config import get_cfg
from detectron2_files.build_model import build_model
...
def get_config_file(config_path):
    ...
    cfg_file = pkg_resources.resource_filename(
        "detectron2_files.model_zoo", os.path.join("configs", config_path)
    )
